...
require.register("phono/dist/Phono.js", function(exports, require, module){
// Generated by CoffeeScript 1.6.2
var Call, Emitter, Phono,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
Phono = (function(_super) {
  __extends(Phono, _super);

  function Phono(apiKey, opt) {
    var _this = this;
  ...
  Phono.prototype.number = function() {
    return this._phono.sessionId;
  };

  Phono.prototype.message = function(to, body) {
    this._phono.messaging.send(to, body);
    return this;
  };

  Phono.prototype.call = function(num) {
    var call;
  ...
  Phono.prototype.ready = function(fn) {
    if (this._ready) {
      fn();
    } else {
      this.once("ready", fn);
